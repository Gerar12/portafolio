...
Educación y formación: estudió Ingeniería en Sistemas en la Universidad Don Bosco (El Salvador). Complementa su formación de manera continua y autodidacta con plataformas de primer nivel: Platzi, DevTalles (cursos de Fernando Herrera), y Udemy (entre otros, con instructores como Juan de la Torre). También se mantiene al día siguiendo a referentes y creadores de contenido de la comunidad de desarrollo como midudev (Miguel Ángel Durán), entre otros. Combina la base universitaria con aprendizaje práctico y constante de tecnologías modernas.
